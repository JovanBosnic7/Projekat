...
{
    [MetadataType(typeof(PrijavaReklamacijaZalbaMetadata))]
    public partial class PrijavaReklamacijaZalba
    {
        public class PrijavaReklamacijaZalbaMetadata
        {
            ...
            public int? UserIdPoslednjeIzmene { get; set; }
            ...
            private PrijavaReklamacijaZalbaMetadata() { }
        }
    }
}