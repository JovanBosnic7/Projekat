...
{
    [MetadataType(typeof(KovertaZaOtkupninuMetadata))]
    public partial class KovertaZaOtkupninu
    {
        public class KovertaZaOtkupninuMetadata
        {
            public string TipZadatka { get; set; }
            public string RegionReonN { get; set; }
            ...
            private KovertaZaOtkupninuMetadata() { }
        }
    }
}
